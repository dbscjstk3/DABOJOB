...
export const mockNewsData: Record<string, NewsResponse[]> = {
  '1': [
    ...
    },
    {
      newsId: 3,
      summaryHashtagId: 12,
      url: 'https://news.example.com/samsung-3nm-process',
      title: '삼성전자 3나노 공정, 글로벌 파운드리 수주 급증',
      content:
    ...
    },
    {
      newsId: 4,
      summaryHashtagId: 13,
      url: 'https://news.example.com/samsung-sustainability',
      title: '삼성전자, 2030년 탄소중립 목표 달성을 위한 RE100 확대',
      content:
    ...
    },
    {
      newsId: 5,
      summaryHashtagId: 14,
      url: 'https://news.example.com/samsung-earnings-q4',
      title: '삼성전자 4분기 실적, 메모리 반도체 호황으로 사상 최대 매출 전망',
      content:
  ...
  '2': [
    // LG전자 관련 뉴스
    {
      newsId: 6,
      summaryHashtagId: 20,
      url: 'https://news.example.com/lg-ev-components',
      title: 'LG전자, GM과 전기차 부품 공급 계약 50조원 규모로 확대',
      content:
    ...
    },
    {
      newsId: 7,
      summaryHashtagId: 21,
      url: 'https://news.example.com/lg-oled-innovation',
      title: 'LG전자, 차세대 마이크로OLED 기술로 AR/VR 시장 진출',
      content:
  ...
  '3': [
    // SK하이닉스 관련 뉴스
    {
      newsId: 8,
      summaryHashtagId: 30,
      url: 'https://news.example.com/sk-hynix-hbm4',
      title: 'SK하이닉스, HBM4 개발 완료로 AI 메모리 시장 주도권 확보',
      content:
    ...
    },
    {
      newsId: 9,
      summaryHashtagId: 31,
      url: 'https://news.example.com/sk-hynix-cxl',
      title: 'SK하이닉스, CXL 메모리로 데이터센터 시장 공략 본격화',
      content:
